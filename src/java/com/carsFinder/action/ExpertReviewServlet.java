 ...
 * @author xmrui_000
 */
public class ExpertReviewServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<ModelInfo> listin = carsBean.getExpertReview(make,model,year);
           for (int i = 0; i < listin.size(); i++) {
                System.out.println(listin.get(0).getExpertReview());
                
                    temporary += listin.get(0).getExpertReview();
